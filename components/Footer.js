    ...
    <footer className="mt-auto  bg-black text-white">
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-12 px-4">
        ...
        <div className="text-center">
          <div className="mb-4">
            <a href="https://www.instagram.com/magicwoodwork" target="_blank" rel="noopener noreferrer" className="inline-block hover:text-gray-300">
          ...
          <p className="text-sm mb-1">© 2021 by Magic Wood Work. All rights reserved.</p>
          <p className="text-xs text-gray-400">Powered by Koreforge</p>
        </div>
