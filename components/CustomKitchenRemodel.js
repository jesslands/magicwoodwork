        ...
        return (
          <section className="text-white py-8 sm:py-12">
            <div className="container mx-auto px-4">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-[#ac9172]">Custom Kitchen Remodel</h2>
