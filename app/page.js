  ...
  return (
    <main className="relative">
      ...
      <div className="h-screen">
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 lg:w-[90%] mx-auto">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 mx-auto border border-r-1 border-[#9a8a78] lg:w-[90%]">
          <div className="border border-r-1 border-[#9a8a78] p-12 py-24  lg:p-40">
